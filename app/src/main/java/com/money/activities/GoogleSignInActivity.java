 ...
 */
public class GoogleSignInActivity extends BaseGoogleSignInActivity implements
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    startActivity(new Intent(GoogleSignInActivity.this, LauncherActivity.class));
                    finish();
                } else {
                    // User is signed out
